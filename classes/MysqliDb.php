...
class MysqliDb
{
    ...
    {
        /**
         * Commenting below line based on
         * https://github.com/ajillion/PHP-MySQLi-Database-Class/issues/43
         */
        //$this->_query = filter_var($query, FILTER_SANITIZE_STRING);  //Issue 43
        $this->_query = $query;
    ...
    protected function _dynamicBindResults(mysqli_stmt $stmt)
    {
        if($stmt->affected_rows > 0){
          //Statement is not a select statement, its an update or delete
          return true;
        }
        $parameters = array();
        $results = array();
        ...
        if($meta === false){
          //Possibly not a select statement
          return $results;
        }
